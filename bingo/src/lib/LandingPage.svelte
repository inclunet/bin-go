<div class="container">
    <header class="my-5">
        ...
        <p>
            ...
            criamos uma experiência de jogo que promove a inclusão e a diversão para <strong><em>todos</em></strong>.
        </p>
    </header>
    ...
    <section class="mt-4">
        <p>
            ...
            <a href="/terms" class="btn btn-warning btn-sm term">Termos de uso</a>
